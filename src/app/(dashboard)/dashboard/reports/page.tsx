    ...
    <div className="p-6 space-y-6">
      ...
      {reports.length === 0 ? (
        <div className="bg-white/5 border border-white/8 rounded-2xl p-12 text-center">
          <Zap className="h-12 w-12 text-[#00E676]/40 mx-auto mb-4" />
          ...
          <Link href="/dashboard/competitors" className="inline-flex items-center gap-2 text-[#00E676] text-sm hover:underline">
        ...
        <div className="space-y-4">
          {reports.map((report) => (
            <div key={report.id} className="bg-white/5 border border-white/8 rounded-2xl p-5">
              ...
              {report.summary && (
                <div className="bg-[#00E676]/8 border border-[#00E676]/15 rounded-xl p-4 mb-4">
                  <p className="text-xs font-semibold text-[#00E676] mb-1.5">Résumé exécutif</p>
